...
namespace lab_fs {
    ...
    enum fs_result {
        SUCCESS, EXISTS, NO_SPACE, NOT_FOUND, TOO_BIG, INVALID_NAME, INVALID_POS, ALREADY_OPENED, FAILED
    };
    ...
    public:
        ...
        auto write(std::size_t i, std::vector<std::byte>::iterator mem_area, std::size_t count) -> fs_result;
